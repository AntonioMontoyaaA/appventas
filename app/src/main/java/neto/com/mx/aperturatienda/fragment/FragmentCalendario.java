...
import neto.com.mx.aperturatienda.databinding.FragmentCalendarioBinding;
...
public class FragmentCalendario extends DialogFragment {
    ...
    public interface InterfaceFragmentCalendario{
        void fechaSeleccionada(String fechaSeleccionada);
    };
    private InterfaceFragmentCalendario listener;

    public void setListener(InterfaceFragmentCalendario listener) {
